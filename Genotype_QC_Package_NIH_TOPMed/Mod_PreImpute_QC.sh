...
plink --bfile hapmap3_bin_snplis --geno 0.05 --out pca --make-bed --pca
...
gcta --bfile after_gender_heterozyg_hapmap --make-grm --out GRM_matrix --autosome --maf 0.05
gcta --grm-cutoff 0.125 --grm GRM_matrix --out GRM_matrix_0125 --make-grm
gcta --bfile after_gender_heterozyg_hapmap --keep GRM_matrix_0125.grm.id --make-bed --out after_gender_heterozyg_hapmap_pihat
