...
output_folder=$3
cohort=$4
output_name=${output_folder}/${cohort}.PD
...
Rscript ~/runs/lang/software/PRSice-2_3_5/PRSice.R \
    ...
    --a1 EA \
    --a2 NEA \
    --base /lustre03/project/6004655/COMMUN/runs/go_lab/summary_stats/PD_2025/GP2_euro_ancestry_meta_analysis_2024/GP2_ALL_EUR_ALL_DATASET_HG38_12162024.rsid.PRS.txt.gz \
    --no-regress \
    --beta \
    --bar-levels 1 \
    --fastscore \
